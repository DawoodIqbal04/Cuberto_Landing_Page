  ...
  return (
    <div className="relative w-full h-20 flex items-center justify-between px-6 lg:px-8 md:px-14 text-black">
      ...
      <div className="flex items-center gap-3.5">
        <div className={`mr-10 font-medium lg:flex hidden overflow-hidden w-max h-max`}>
          <p ref={menuRef}>menu</p>
        </div>
        <div ref={burgerRef} className="flex flex-col items-center lg:gap-[2.5px] gap-1.5 fixed lg:right-10 md:right-14 right-8 z-50">
