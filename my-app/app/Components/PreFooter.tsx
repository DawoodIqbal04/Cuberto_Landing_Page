...
const PreFooter = () => {
  return (
    <div className="relative w-full lg:h-screen bg-[#000000] text-white flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center lg:gap-8 gap-6 text-center lg:text-8xl text-5xl font-normal">
        <div className="">
          <p>
            Have
            <br /> An Idea?
        ...
        <div className="lg:w-116 w-65 h-20 border border-white rounded-full flex items-center justify-center">
          <p>TELL US</p>
        </div>
      </div>
    </div>
