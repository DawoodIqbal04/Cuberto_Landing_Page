...
const About = () => {
  return (
    <div
      className={`font-medium w-full min-h-screen flex lg:flex-row flex-col lg:gap- gap-10 items-center lg:justify-normal justify-center text-black lg:px-40 md:px-14 px-6 lg:py-40`}
    >
